...
testedWith:
  - "Node.js 22.22.0 deterministic cost fixture"
evidence:
  - "fixtures/cost-model.mjs"
  - "tests/content/cost-model.test.mjs"
claimRefs:
  - CLM-COST-001
  - CLM-COST-002
  - CLM-COST-003
...
<AcceptanceWorkbench acceptance-id="ACC-COST-001" />

## 关键断言与证据

<ClaimLedger document-id="KS-COST-MODEL" />
